...
namespace NHST
{
    public partial class _1688MasterLogined : System.Web.UI.MasterPage
    {
        ...
        public void LoadData()
        {
            ...
            if (confi != null)
            {
                ...
                ltrTopLeft.Text += "<div class=\"child tygia\"><p>Tỷ giá đại lý: ¥1 = <span class=\"semibold color\">" + string.Format("{0:N0}", Convert.ToDouble(confi.AgentCurrency)) + "</span></p></div>";
            ...
            if (Session["userLoginSystem"] != null)
            {
                ...
                if (acc != null)
                {
                    ...
                    string serviceMenu = "";
                    serviceMenu += "<li class=\"nav-item thanhtoanho has-dropdown\">";
                    serviceMenu += "    <a href=\"javascript:;\">Thanh toán hộ</a>";
                    serviceMenu += "    <ul class=\"dropdown-menu\">";
                    serviceMenu += "        <li><a href=\"/tao-ma-tth\">Tạo mã TTH</a></li>";
                    serviceMenu += "        <li><a href=\"/quan-ly-ma-tth\">Quản lý mã TTH</a></li>";
                    serviceMenu += "    </ul>";
                    serviceMenu += "</li>";
                    serviceMenu += "<li class=\"nav-item vanchuyenho has-dropdown\">";
                    serviceMenu += "    <a href=\"javascript:;\">Vận chuyển hộ</a>";
                    serviceMenu += "    <ul class=\"dropdown-menu\">";
                    serviceMenu += "        <li><a href=\"/tao-ma-van-don-vch\">Tạo mã vận đơn VCH</a></li>";
                    serviceMenu += "        <li><a href=\"/quan-ly-van-don-vch\">Quản lý vận đơn VCH</a></li>";
                    serviceMenu += "        <li><a href=\"/thong-ke-cuoc-vc-ho\">Thống kê cước VCH</a></li>";
                    serviceMenu += "    </ul>";
                    serviceMenu += "</li>";
                    ...
                    if (role == 1)
                    {
                        if (acc.IsAgent == true)
                        {
                            ltrOrderService.Text = serviceMenu;
                        }
                    }
                    else
                    {

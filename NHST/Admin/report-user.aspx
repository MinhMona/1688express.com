<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="report-user.aspx.cs" Inherits="NHST.Admin.report_user" %>
        ...
        <div class="col-md-12">
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h3 class="panel-title semi-text text-uppercase">Thống kê danh sách tài khoản</h3>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <asp:DropDownList ID="ddlRole" runat="server" CssClass="form-control select2">
                                        ...
                                        <asp:ListItem Value="1">Khách hàng thường</asp:ListItem>
                                        <asp:ListItem Value="11">Khách hàng đại lý</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                <div class="col-md-2">

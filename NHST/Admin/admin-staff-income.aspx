<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="admin-staff-income.aspx.cs" Inherits="NHST.Admin.admin_staff_income" %>
                    ...
                    <div class="row m-b-lg">
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <asp:Button ID="btnFilter" runat="server" CssClass="btn btn-success" Text="Xem" OnClick="btnFilter_Click"
                            ...
                            <div class="row">
                                <div class="col-md-12" style="margin-top: 20px;">
                                    <div class="row">
                                        <div class="col-md-12" style="margin-top: 20px;">
                                            <span class="label-title">Tổng tiền đã thanh toán</span>
                            ...
                            <MasterTableView CssClass="table table-bordered table-hover" DataKeyNames="ID">
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderStyle-Width="5%" HeaderStyle-HorizontalAlign="Center"
                                        ...
                                        <ItemTemplate>
                                            <a class="btn btn-info btn-sm" target="_blank" href='/Admin/OrderDetail.aspx?id=<%#Eval("MainOrderID") %>'>Chi tiết đơn</a>
                                            <br />
                                            <%# Convert.ToInt32(Eval("Status")) == 1?
                                                        "<a class=\"btn btn-info btn-sm\" onclick=\"thanhtoanHoahong('"+Eval("ID")+"',$(this))\" href='javascript:;'>Thanh toán</a>":
                                                        "" %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                </Columns>

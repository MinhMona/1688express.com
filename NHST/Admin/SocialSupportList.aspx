<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="SocialSupportList.aspx.cs" Inherits="NHST.Admin.SocialSupportList" %>
        ...
        <div class="col-md-12">
            <div class="panel panel-white">
                ...
                <div class="panel-body">
                    <a type="button" class="btn btn-success m-b-sm" href="/Admin/AddSocialSupport.aspx">Thêm mạng hỗ trợ mua hàng</a>
                            ...
                            <MasterTableView CssClass="table table-bordered table-hover" DataKeyNames="ID">
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderStyle-Width="10%" HeaderStyle-HorizontalAlign="Center"
                                        ...
                                        <ItemTemplate>
                                            <a class="btn btn-info btn-sm" href='/Admin/EditSocialSupport.aspx?i=<%#Eval("ID") %>'>Sửa</a>
                                            <a class="btn btn-info btn-sm bg-red" href="javascript:;" onclick="DeleteSocialSupport('<%#Eval("ID") %>')">Xóa</a>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                </Columns>

<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddRefund.aspx.cs" Inherits="NHSG.admin.AddRefund" %>
            ...
            <div class="col-md-12">
                <div class="panel panel-white">
                    <div class="panel-heading">
                        <h3 class="panel-title semi-text text-uppercase">Thêm hoàn tiền</h3>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <telerik:RadNumericTextBox runat="server" CssClass="form-control" Skin="MetroTouch"
                                            ID="pAmount" MinValue="0" NumberFormat-DecimalDigits="0" NumberFormat-GroupSizes="3" Width="100%">

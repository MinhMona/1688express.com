...
namespace NHST.Admin
{
    public partial class Add_Package : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    if (ac != null)
                        if (ac.RoleID != 0 && ac.RoleID != 4 && ac.RoleID != 5)
                            Response.Redirect("/trang-chu");
                }
            }
        }
        ...
        protected void btncreateuser_Click(object sender, EventArgs e)
        {
            ...
            {
                string kq = BigPackageController.InsertNew(code, pWeight.Value.ToString().ToFloat(0),
                    pVolume.Value.ToString().ToFloat(0), 1, txtTotalPackage.Text, txtNote.Text,

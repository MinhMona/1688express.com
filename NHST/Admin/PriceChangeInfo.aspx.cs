...
namespace NHSG.admin
{
    public partial class PriceChangeInfo : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            PriceChangeController.Update(ID, Convert.ToDouble(pPriceFromCYN.Value), Convert.ToDouble(pPriceToCYN.Value),
                Convert.ToDouble(pVip0.Value), Convert.ToDouble(pVip1.Value),
                Convert.ToDouble(pVip2.Value), Convert.ToDouble(pVip3.Value), 
                Convert.ToDouble(pVip4.Value), Convert.ToDouble(pVip5.Value),
                Convert.ToDouble(pVip6.Value), Convert.ToDouble(pVip7.Value),
                Convert.ToDouble(pVip8.Value), DateTime.Now, Username);

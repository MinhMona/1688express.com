...
{
    public partial class danh_sach_kh : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    if (ac.RoleID != 0 && ac.RoleID != 2 && ac.RoleID != 5 && ac.RoleID != 4)
                    {
                        Response.Redirect("/trang-chu");
                    }
                }
        ...
        protected void r_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            ...
            var la = AccountController.GetAll_View_Customer("");

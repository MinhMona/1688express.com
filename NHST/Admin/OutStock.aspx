<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="OutStock.aspx.cs" Inherits="NHST.Admin.OutStock" %>
                ...
                <div class="panel panel-white">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mar-bot3">
                                <label style="font-size: 18px;">Số lượng kiện: <span id="countorder">0</span></label>
                            </div>
                        </div>
            ...
            if (check == false) {
                ...
                $.ajax({
                    ...
                    success: function (msg) {
                        ...
                        if (ret == "none") {
                        ...
                        else if (ret == "chuathanhtoan") {
                            alert('Kiện này chưa được thanh toán, vui lòng thử lại sau');
                        }
                        else {
                            ...
                            if (data != "none") {
                                ...
                                if (data.OrderType == 1) {
                                    ...
                                    html += "       </div>";
                                    html += "       <div class=\"row-package\">";
                                    html += "           <span class=\"package-label\"><strong>Tên tài khoản:</strong></span>";
                                    html += "           <span class=\"package-info packageShopCode\"><strong>" + data.Username + "</strong></span>";
                                    //html += "           <span class=\"package-info packageShopCode\"><strong>" + data.MainorderID + "</strong></span>";
                                    html += "       </div>";
                                    html += "       <div class=\"row-package\">";
                                    ...
                                    html += "       </div>";
                                    html += "       <div class=\"row-package\">";
                                    html += "           <span class=\"package-label\"><strong>Tên KHĐL:</strong></span>";
                                    html += "           <span class=\"package-info packageShopCode\"><strong>" + data.Username + "</strong></span>";
                                    //html += "           <span class=\"package-info packageShopCode\"><strong>" + data.MainorderID + "</strong></span>";
                                    html += "       </div>";
                                    //html += "       <div class=\"row-package\">";
                                    ...
                                    html += "           <span class=\"package-info packageCode\">¥" + data.AdditionFeeCYN + " - " + numberWithCommas(data.AdditionFeeVND) + " VNĐ</span>";
                                    html += "       </div>";
                                    html += "       <div class=\"row-package\">";
                                    html += "           <span class=\"package-label\">Phụ phí:</span>";
                                    html += "           <span class=\"package-info packageCode\">¥" + data.SensorFeeCYN + " - " + numberWithCommas(data.SensorFeeVND) + " VNĐ</span>";
                                    html += "       </div>";
                                }
                                //html += "       <div class=\"row-package\">";
                                //html += "           <span class=\"package-label\"><strong>Mã Đơn Hàng:</strong></span>";
                                ...
                                //    html += "       </div>";
                                //    if (data.MainOrderStatus < 9) {
                                //        html += "       <div class=\"row-package \" style='color:red;font-weight:bold;'>Đơn hàng chưa thanh toán";
                                //        html += "       </div>";
                                //    }
        ...
        $.ajax({
            ...
            success: function (msg) {
                ...
                if (data == "ok") {
                    ...
                    $("#" + id).find('.row-package-status').html('Đơn hàng barcode: ' + Barcode + '<br/> Còn thiếu: ' + data + ' VNĐ tiền lưu kho để nhận hàng.');
                }
                remove_loading();
                countOrder();
            },

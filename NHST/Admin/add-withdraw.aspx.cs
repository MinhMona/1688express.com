...
namespace NHST.Admin
{
    public partial class add_withdraw : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            {
                Response.Redirect("/Admin/Withdraw-List.aspx");
            }
        }
        ...
        protected void btncreateuser_Click(object sender, EventArgs e)
        {
            ...
            string BackLink = "/Admin/Withdraw-List.aspx";
            if (acc != null)
            {
                int UID = acc.ID;
                ...
                if (wallet >= amount)
                {
                    ...
                    PJUtils.ShowMessageBoxSwAlertBackToLink("Tạo lệnh rút tiền thành công", "s", false, BackLink, Page);
                }
                else
                {
                    PJUtils.ShowMessageBoxSwAlert("Số tiền không đủ để tạo lệnh rút", "e", false, Page);
                }
            }
            else
            {
                PJUtils.ShowMessageBoxSwAlert("Không tồn tại tài khoản trên", "e", false, Page);
            }
        }
    }
}
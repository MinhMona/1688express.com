<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="report-income-userdathang.aspx.cs" Inherits="NHST.Admin.report_income_userdathang" %>
        ...
        <div class="col-md-12">
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h3 class="panel-title semi-text text-uppercase">Thống kê hoa hồng nhân viên</h3>
                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12" style="margin-top: 20px;">
                                    <div class="row">
                                        <div class="col-md-12" style="margin-top: 20px;">
                                            <span class="label-title">Tổng đơn đã đặt</span>
                                        ...
                                        <div class="col-md-12" style="margin-top: 20px;">
                                            ...
                                            <span class="label-infor">
                                                <asp:Label ID="lblOrderPrice" runat="server" Text="0"></asp:Label>
                                            </span>
                                        </div>
                                        <div class="col-md-12" style="margin-top: 20px;">
                                            <span class="label-title">Tổng tiền phí hải quan</span>
                                            <span class="label-infor">
                                                <asp:Label ID="lblOrderFeeBuyProduct" runat="server" Text="0"></asp:Label>
                                            </span>
                                        </div>
                                        <div class="col-md-12" style="margin-top: 20px;">
                                            <span class="label-title">Tổng tiền phí tùy chọn</span>
                                            <span class="label-infor">
                                                <asp:Label ID="lblFeeOption" runat="server" Text="0"></asp:Label>
                                            </span>
                                        </div>
                                        <div class="col-md-12" style="margin-top: 20px;">
                                            <span class="label-title">Tổng tiền cước vận chuyển đặt thành công</span>
                                            <span class="label-infor">
                                                <asp:Label ID="lblFeeWeight" runat="server" Text="0"></asp:Label>
                                            </span>
                                        </div>
                                    </div>
                                </div>

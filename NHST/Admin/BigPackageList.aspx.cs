...
namespace NHST.Admin
{
    public partial class BigPackageList : System.Web.UI.Page
    {
                ...
                if (ui != null)
                {
                    ...
                    if (acs.Count > 0)
                    {
                        ...
                        for (int i = FromRow; i < ToRow + 1; i++)
                        {
                            ...
                            ltrorderlist.Text += "  <td colspan=\"2\"><a class=\"btn btn-info btn-sm\" target=\"_blank\" href=\"/Admin/BigPackageDetail.aspx?ID=" + item.ID + "\">Xem</a></td>";
                            ...
                            if (sps.Count > 0)
                            {
                                foreach (var s in sps)
                                {
                                    ...
                                    ltrorderlist.Text += "  <td><a class=\"btn btn-info btn-sm\" target=\"_blank\" href=\"/admin/getprintbarcode.aspx?code=" + s.packagecode + "\">Lấy barcode</a></td>";
                                    ltrorderlist.Text += "</tr>";
                                }
                            }
                        }
        ...
        {
            Response.Redirect("/admin/bigpackagelist.aspx?code=" + tSearchName.Text + "");
            //gr.Rebind();
        }
        #endregion

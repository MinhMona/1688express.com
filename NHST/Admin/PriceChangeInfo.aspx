<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="PriceChangeInfo.aspx.cs" Inherits="NHSG.admin.PriceChangeInfo" %>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="exampleInputEmail">
                                            Vip 0
                                            <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator9" ControlToValidate="pVip0" SetFocusOnError="true"
                                                ValidationGroup="n" ErrorMessage="(*)" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </label>
                                        <telerik:RadNumericTextBox runat="server" CssClass="form-control width-notfull" Skin="MetroTouch"

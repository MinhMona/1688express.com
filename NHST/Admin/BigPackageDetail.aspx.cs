                    ...
                    if (b != null)
                    {
                        ...
                        if (sps.Count > 0)
                        {
                            ...
                            foreach (var item in sps)
                            {
                                ...
                                html.Append("<div class=\"col-md-2\">Mã vận đơn:</div>");
                                html.Append("<div class=\"col-md-2\"><input disabled type=\"text\" class=\"packageCode form-control\" value=\"" + item.PackageCode + "\"/></div>");
                                html.Append("<div class=\"col-md-2\">User Phone:</div>");
                                html.Append("<div class=\"col-md-2\"><input type=\"text\" class=\"packageUserPhone form-control\" value=\"" + item.UserPhone + "\"/></div>");
                                html.Append("<div class=\"col-md-2\">Trọng lượng (kg):</div>");
                                html.Append("<div class=\"col-md-2\"><input type=\"text\" class=\"packageWeight form-control\" value=\"" + item.Weight.ToString().Replace(",", ".") + "\"/></div>");
                                //html.Append("<div class=\"col-md-2\">Trạng thái nhận hàng:</div>");
                                //html.Append("<div class=\"col-md-2\"><input type=\"hidden\" class=\"packagenhanhang \" value=\"" + item.StatusReceivePackage + "\" />" + PJUtils.ReturnStatusReceivePackage(Convert.ToInt32(item.StatusReceivePackage)) + "</div>");
                                //html.Append("<div class=\"col-md-2\">Trạng thái thanh toán:</div>");
                                //html.Append("<div class=\"col-md-2\"><input type=\"hidden\" class=\"packagethanhtoan \" value=\"" + item.StatusPayment + "\" />" + PJUtils.ReturnStatusPayment(Convert.ToInt32(item.StatusPayment)) + "</div>");
                                html.Append("<div class=\"col-md-2\" style=\"padding-top: 5px;padding-bottom:5px;\">Ghi chú:</div>");
                                html.Append("<div class=\"col-md-2\" style=\"padding-top: 5px;padding-bottom:5px;\"><textarea class=\"packageNote form-control\" oninput=\"onchange($(this))\">" + item.Note + "</textarea></div>");
                                html.Append("<div class=\"col-md-2\" style=\"padding-top: 5px;padding-bottom:5px;\">Trạng thái nhận hàng:</div>");
                                if (item.StatusReceivePackage == 0)
                                    html.Append("<div class=\"col-md-2\" style=\"padding-top: 5px;padding-bottom:5px;\"><select class=\"packageStatusReceived\" disabled><option value=\"0\">Chưa nhận hàng</option><option value=\"1\">Đã nhận hàng</option></select></div>");
                                else
                                    html.Append("<div class=\"col-md-2\" style=\"padding-top: 5px;padding-bottom:5px;\"><select class=\"packageStatusReceived\" disabled><option value=\"0\">Chưa nhận hàng</option><option value=\"1\" selected>Đã nhận hàng</option></select></div>");

                                html.Append("<div class=\"col-md-2\" style=\"padding-top: 5px;padding-bottom:5px;\">Trạng thái thanh toán:</div>");

                                if (item.StatusPayment == 0)
                                    html.Append("<div class=\"col-md-2\" style=\"padding-top: 5px;padding-bottom:5px;\"><select class=\"packageStatusPayment\" disabled><option value=\"0\">Chưa thanh toán</option><option value=\"1\">Đã thanh toán</option></select></div>");
                                else
                                    html.Append("<div class=\"col-md-2\" style=\"padding-top: 5px;padding-bottom:5px;\"><select class=\"packageStatusPayment\" disabled><option value=\"0\">Chưa thanh toán</option><option value=\"1\" selected>Đã thanh toán</option></select></div>");

                                html.Append("<div class=\"col-md-2\" style=\"padding-top: 5px;padding-bottom:5px;\">Ghi chú khách hàng:</div>");
                                html.Append("<div class=\"col-md-2\" style=\"padding-top: 5px;padding-bottom:5px;\"><textarea class=\"packageNoteCus form-control\">" + item.NoteCustomer + "</textarea></div>");
                                html.Append("</div>");
                            }
                                    ...
                                    for (int i = 0; i < itemlist.Length - 1; i++)
                                    {
                                        ...
                                        if (!string.IsNullOrEmpty(pCode) && !string.IsNullOrEmpty(pUserPhone) && !string.IsNullOrEmpty(pWeight))
                                        {
                                            ...
                                            if (u != null)
                                            {
                                                try
                                                {
                                                    PJUtils.SendMailGmail("no-reply@mona-media.com", "fufgtsqnrjnxyuhf", u.Email,
                                                            "Thông báo nhận hàng tại 1688 Express.",

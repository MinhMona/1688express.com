        ...
        protected void btngetpass_Click(object sender, EventArgs e)
        {
            ...
            if (user != null)
            {
                ...
                if (kq == "1")
                {
                    try
                    {
                        PJUtils.SendMailGmail("order1688express@gmail.com", "tkvrdkmkrzgbfjss", txtEmail.Text.Trim(), "Reset Mật khẩu trên Vận chuyển đa quốc gia", "Mật khẩu mới của bạn trên hệ thống Vận chuyển đa quốc gia: <strong>" + password + "</strong>", "");
                    }
                    catch
                    {

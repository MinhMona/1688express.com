<%@ Page Title="" Language="C#" MasterPageFile="~/1688MasterLogined.Master" AutoEventWireup="true" CodeBehind="them-khieu-nai.aspx.cs" Inherits="NHST.them_khieu_nai1" %>
                            ...
                            <div class="step-income">
                                <asp:Panel ID="pn" runat="server">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <asp:TextBox ID="txtOrderCode" runat="server" CssClass="form-control full-width" Enabled="false"></asp:TextBox>
                                    </div>
                                    <%--<div class="form-row">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <telerik:RadAsyncUpload Skin="Metro" runat="server" ID="hinhDaiDien" ChunkSize="0"
                                            ...
                                            MultipleFileSelection="Automatic" MaxFileInputsCount="5" OnClientFileSelected="OnClientFileSelected">

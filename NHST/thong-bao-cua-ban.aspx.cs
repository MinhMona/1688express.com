...
namespace NHST
{
    public partial class thong_bao_cua_ban : System.Web.UI.Page
    {
        ...
        public void pagingall(List<tbl_Notifications> acs)
        {
            ...
            if (acs.Count > 0)
            {
                ...
                for (int i = FromRow; i < ToRow + 1; i++)
                {
                    ...
                    var item = acs[i];
                    int type = Convert.ToInt32(item.NotifType);
                    if (item.Status == 1)
                        stt = "Đã xem";
                    ltr.Text += "<tr>";
                    ...
                    if (role == 1)
                    {
                        if (item.NotifType == 1)
                        {
                            ltr.Text += "   <td><a href=\"/chi-tiet-don-hang/" + item.OrderID + "\" target=\"_blank\">" + item.Message + "</a></td>";
                        }
                        else if (item.NotifType == 7)
                        {
                            ltr.Text += "   <td><a href=\"/quan-ly-ma-tth\" target=\"_blank\">" + item.Message + "</a></td>";
                        }
                        else if (item.NotifType == 2)
                        {
                            ltr.Text += "   <td><a href=\"/lich-su-giao-dich\" target=\"_blank\">" + item.Message + "</a></td>";
                        }
                        ...
                        {
                            ltr.Text += "   <td><a href=\"/quan-ly-van-don-vch\" target=\"_blank\">" + item.Message + "</a></td>";
                        }
                        else
                        {
                            ltr.Text += "   <td><a href=\"javascript:;\" target=\"_blank\">" + item.Message + "</a></td>";
                        }
                    }
                    else
                    {
                        if (type == 1)
                            ltr.Text += "   <td><a href=\"/Admin/OrderDetail.aspx?id=" + item.OrderID + "\" target=\"_blank\">" + item.Message + "</a></td>";
                        else if (type == 2)
                            ltr.Text += "   <td><a href=\"/Admin/HistorySendWallet.aspx\" target=\"_blank\">" + item.Message + "</a></td>";
                        else if (type == 3)
                            ltr.Text += "   <td><a href=\"/Admin/Withdraw-List.aspx\" target=\"_blank\">" + item.Message + "</a></td>";
                        else if (type == 3)
                            ltr.Text += "   <td><a href=\"/Admin/OrderDetail.aspx?id=" + item.OrderID + "\" target=\"_blank\">" + item.Message + "</a></td>";                        
                        else if (type == 5)
                            ltr.Text += "   <td><a href=\"/Admin/ComplainList.aspx\" target=\"_blank\">" + item.Message + "</a></td>";                        
                        else if (type == 6)
                            ltr.Text += "   <td><a href=\"/Admin/UserList.aspx\" target=\"_blank\">" + item.Message + "</a></td>";                        
                        else if (type == 7)
                            ltr.Text += "   <td><a href=\"/Admin/payforlist.aspx\" target=\"_blank\">" + item.Message + "</a></td>";                        
                        else if (type == 10)
                            ltr.Text += "   <td><a href=\"/Admin/request-outstock.aspx\" target=\"_blank\">" + item.Message + "</a></td>";
                        else
                            ltr.Text += "   <td><a href=\"/Admin/OrderDetail.aspx?id=" + item.OrderID + "\" target=\"_blank\">" + item.Message + "</a></td>";
                    }
                    ltr.Text += "   <td>" + stt + "</td>";

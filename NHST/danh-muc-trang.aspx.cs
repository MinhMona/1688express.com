        ...
        public void loadData()
        {
            try
            {
                ...
                if (pt != null)
                {
                    ...
                    lblTitle.Text = pagetypename;
                    ltrSummary.Text = pt.PageTypeDescription;
                    ...
                    string weblink = "https://1688express.com.vn";
                    ...
                    if (!string.IsNullOrEmpty(pt.ogimage))
                        ...
                        objMetaFacebook.Content = weblink + "/App_Themes/1688/images/logo-header.png";
        ...
        public void pagingall(List<ListPage> acs)
        {
            ...
            if (acs.Count > 0)
            {
                ...
                for (int i = FromRow; i < ToRow + 1; i++)
                {
                    ...
                    //html.Append("<div class=\"sv-list-detail sv-list-main\">");
                    //html.Append("<div class=\"sv-img\">");
                    //html.Append("<a href=\"/" + item.PageTypeID + "/" + page.ID + "/" + LeoUtils.ConvertToUnSign(item.PageTypeName)
                    //    + "/" + LeoUtils.ConvertToUnSign(page.Title) + "\"><img src=\"" + PJUtils.GetIcon(page.IMG) + "\" alt=\"" + page.Title + "\"></a>");
                    //html.Append("</div>");
                    //html.Append("<div class=\"sv-text\">");
                    //html.Append("<img src=\"/App_Themes/pdv/assets/images/span-yellow.png\" alt=\"#\">");
                    //html.Append("<h3><a href=\"/" + item.PageTypeID + "/" + page.ID + "/" + LeoUtils.ConvertToUnSign(item.PageTypeName)
                    //    + "/" + LeoUtils.ConvertToUnSign(page.Title) + "\"><img src=\"" + PJUtils.GetIcon(page.IMG) + "\">" + page.Title + "</a></h3>");
                    //html.Append("<p>" + page.Summary + "</p>");
                    //html.Append("</div></div>");
                    html.Append("<div class=\"sv-list-detail sv-list-main\">");
                    html.Append("<div class=\"sv-img\">");
                    html.Append("<a href=\"" + page.NodeAliasPath + "\"><img src=\"" + PJUtils.GetIcon(page.IMG) + "\" alt=\"" + page.Title + "\"></a>");
                    html.Append("</div>");
                    html.Append("<div class=\"sv-text\">");
                    html.Append("<img src=\"/App_Themes/pdv/assets/images/span-yellow.png\" alt=\"#\">");
                    html.Append("<h3><a href=\"" + page.NodeAliasPath + "\">" + page.Title + "</a></h3>");
                    html.Append("<p>" + PJUtils.SubString(page.Summary, 120) + "</p>");
                    html.Append("</div></div>");

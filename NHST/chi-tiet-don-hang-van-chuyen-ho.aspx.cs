            ...
            if (obj_user != null)
            {
                ...
                if (id > 0)
                {
                    ...
                    if (t != null)
                    {
                        ...
                        if(ShippingType == 1)
                        {
                            shippingTypeName = "Đi nhanh";
                        }
                        else
                        {
                            shippingTypeName = "Đi thường";
                        }                        
                        if (stt == 0)
                        {
            ...
            if (obj_user != null)
            {
                ...
                if (id > 0)
                {
                    ...
                    if (t != null)
                    {
                        ...
                        var WarehouseFee = WarehouseFeeController.GetByAndWarehouseFromAndToWarehouseAndShippingTypeAndAndHelpMoving(wareTo, shippingType, true);

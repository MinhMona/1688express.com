...
namespace NHST.Controllers
{
    ...
    {
        #region CRUD
        public static string Insert(string MenuName, string MenuLink, bool IsHidden, DateTime CreatedDate, string CreatedBy)
        {
        ...
        public static string Update(int ID, string MenuName, string MenuLink, bool IsHidden, DateTime ModifiedDate, string ModifiedBy)
        {
            using (var dbe = new NHSTEntities())
            {
        ...
        public static tbl_Menu GetByID(int ID)
        {
            using (var dbe = new NHSTEntities())
            {
                tbl_Menu page = dbe.tbl_Menu.Where(p => p.ID == ID).SingleOrDefault();
                if (page != null)
                    return page;
                else
                    return null;

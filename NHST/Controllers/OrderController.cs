...
namespace NHST.Controllers
{
    public class OrderController
    {
        ...
        public static string UpdateStatus(int ID, int UID, int Status)
        {
            using (var dbe = new NHSTEntities())
            {
                var or = dbe.tbl_Order.Where(o => o.UID == UID && o.ID == ID).SingleOrDefault();
                if (or != null)
                {
                    or.Status = Status;
                    dbe.Configuration.ValidateOnSaveEnabled = false;
        ...
        public static string UpdateStatusByID(int ID, int Status)
        {
            using (var dbe = new NHSTEntities())
            {
                var or = dbe.tbl_Order.Where(o => o.ID == ID).SingleOrDefault();
                if (or != null)
                {
                    or.Status = Status;
                    dbe.Configuration.ValidateOnSaveEnabled = false;
        ...
        public static string UpdateBrand(int ID, string Brand)
        {
            using (var dbe = new NHSTEntities())
            {
                var ot = dbe.tbl_Order.Where(o => o.ID == ID).SingleOrDefault();
                if (ot != null)
                {
                    ot.brand = Brand;
                    dbe.Configuration.ValidateOnSaveEnabled = false;
        ...
        public static string UpdateIsCencor(int ID, bool IsCensorProduct, string PriceOfCensorCYN, string PriceOfCensorVND)
        {
            using (var dbe = new NHSTEntities())
            {
                var ot = dbe.tbl_Order.Where(o => o.ID == ID).SingleOrDefault();
                if (ot != null)
                {
                    ot.IsCensorProduct = IsCensorProduct;
                    ot.PriceOfCensorCYN = PriceOfCensorCYN;
                    ot.PriceOfCensorVND = PriceOfCensorVND;
                    dbe.Configuration.ValidateOnSaveEnabled = false;
                    string kq = dbe.SaveChanges().ToString();
                    return "ok";
                }
        ...
        public static string UpdateOrderShopCode(int ID, string OrderShopCode)
        {
            using (var dbe = new NHSTEntities())
            {
                var ot = dbe.tbl_Order.Where(o => o.ID == ID).SingleOrDefault();
                if (ot != null)
                {
                    ot.OrderShopCode = OrderShopCode;
                    dbe.Configuration.ValidateOnSaveEnabled = false;
                    string kq = dbe.SaveChanges().ToString();
                    return "ok";
                }
        ...
        public static string UpdateFeeShipCNByShopIDAndMainOrderID(int mainorderID, string shopID, string FeeShipCN)
        {
            using (var dbe = new NHSTEntities())
            {
                var or = dbe.tbl_Order.Where(o => o.MainOrderID == mainorderID && o.shop_id == shopID).ToList();
                if (or.Count>0)
                {
                    foreach (var item in or)
                    {
                        item.FeeShipCN = FeeShipCN;
                        dbe.Configuration.ValidateOnSaveEnabled = false;
                        dbe.SaveChanges();
                    }
        ...
        public static string Update3TotalByShopIDAndMainOrderID(int mainorderID, string shopID,
            double TotalPriceShopCYN, double TotalPriceShopVND, double TotalShopQuantity)
        {
            using (var dbe = new NHSTEntities())
            {
                var or = dbe.tbl_Order.Where(o => o.MainOrderID == mainorderID && o.shop_id == shopID).ToList();
                if (or.Count > 0)
                {
                    foreach (var item in or)
                    {
                        item.TotalPriceShopCYN = TotalPriceShopCYN;
                        item.TotalPriceShopVND = TotalPriceShopVND;
                        item.TotalShopQuantity = TotalShopQuantity;
                        dbe.Configuration.ValidateOnSaveEnabled = false;
                        dbe.SaveChanges();
                    }
        ...
        #endregion
        #region Select
        public static List<string> GetByMainOrderIDGroupByShopID(int MainOrderID)
        {
            var list = new List<string>();
            var sql = @"select shop_id from tbl_Order where MainOrderID=" + MainOrderID + " group by shop_id";
            var reader = (IDataReader)SqlHelper.ExecuteDataReader(sql);
            while (reader.Read())
            {
                string shopid = "";
                if (reader["shop_id"] != DBNull.Value)
                    shopid = reader["shop_id"].ToString();
                list.Add(shopid);
            }
            reader.Close();
            return list;
        ...
        public static string SelectUIDByIDOrder(int ID)
        {
            using (var dbe = new NHSTEntities())
            {
                var ot = dbe.tbl_OrderTemp.Where(o => o.ID == ID).SingleOrDefault();
                if (ot != null)
                {
        ...
        public static List<tbl_Order> GetByMainOrderID(int MainOrderID)
        {
            ...
            {
                List<tbl_Order> lo = new List<tbl_Order>();
                lo = dbe.tbl_Order.Where(o => o.MainOrderID == MainOrderID).OrderBy(o => o.shop_id).ToList();
                return lo;
            }
        }
        public static List<tbl_Order> GetByMainOrderIDAndShopID(int MainOrderID, string shopID)
        {
            using (var dbe = new NHSTEntities())
            {
                List<tbl_Order> lo = new List<tbl_Order>();
                lo = dbe.tbl_Order.Where(o => o.MainOrderID == MainOrderID && o.shop_id == shopID).OrderBy(o => o.shop_id).ToList();
                return lo;
            }
        }
        ...
        public static tbl_Order GetAllByUIDAndID(int UID, int ID)
        {
            using (var dbe = new NHSTEntities())
            {
                var lo = dbe.tbl_Order.Where(o => o.UID == UID && o.ID == ID).SingleOrDefault();
                if (lo != null)
                    return lo;
                else
                    return null;
        ...
        public static tbl_Order GetAllByID(int ID)
        {
            using (var dbe = new NHSTEntities())
            {
                var lo = dbe.tbl_Order.Where(o => o.ID == ID).SingleOrDefault();
                if (lo != null)
                    return lo;
                else
                    return null;

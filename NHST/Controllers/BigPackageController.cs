...
namespace NHST.Controllers
{
    public class BigPackageController
    {
        ...
        public static string InsertNew(string PackageCode, double Weight, double Volume, int Status, 
            string TotalPackage, string Note,
        ...
        public static string Update(int ID, string PackageCode, double Weight, double Volume, int Status, DateTime ModifiedDate, string ModifiedBy)
        {
            ...
            {
                dbe.Configuration.ValidateOnSaveEnabled = false;
                tbl_BigPackage a = dbe.tbl_BigPackage.Where(ad => ad.ID == ID).SingleOrDefault();
                if (a != null)
                {
                    a.PackageCode = PackageCode;
                    a.Weight = Weight;
        ...
        public static string UpdateNew(int ID, string PackageCode, double Weight, double Volume, int Status, 
            string TotalPackage, string Note,
        ...
        public static tbl_BigPackage GetByPackageCode(string PackageCode)
        {
            using (var dbe = new NHSTEntities())
            {
                tbl_BigPackage a = dbe.tbl_BigPackage.Where(ad => ad.PackageCode == PackageCode).SingleOrDefault();
                if (a != null)
                {
                    return a;
                }

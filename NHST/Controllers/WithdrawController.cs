...
namespace NHST.Controllers
{
    ...
    {        
        ...
        public static string Insert(int UID, string Username, double Amount, int Status, DateTime CreatedDate, string CreatedBy)
        {
            using (var dbe = new NHSTEntities())
            {
                tbl_Withdraw a = new tbl_Withdraw();
        ...
        public static string InsertNote(int UID, string Username, double Amount, int Status,string Note, DateTime CreatedDate, string CreatedBy)
        {
            using (var dbe = new NHSTEntities())
            {
                tbl_Withdraw a = new tbl_Withdraw();
        ...
        public static string UpdateStatus(int ID, int Status, DateTime ModifiedDate, string ModifiedBy)
        {
            using (var dbe = new NHSTEntities())
            {
                var a = dbe.tbl_Withdraw.Where(f => f.ID == ID).SingleOrDefault();
                if (a != null)
                {
                    a.Status = Status;
        ...
        public static tbl_Withdraw GetByUIDAndID(int UID, int ID)
        {
            using (var dbe = new NHSTEntities())
            {
                var a = dbe.tbl_Withdraw.Where(f => f.ID == ID && f.UID == UID).SingleOrDefault();
                if (a != null)
                {
                    return a;
                }

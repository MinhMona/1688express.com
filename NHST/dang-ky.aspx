<%@ Page Title="" Language="C#" MasterPageFile="~/1688Master.Master" AutoEventWireup="true" CodeBehind="dang-ky.aspx.cs" Inherits="NHST.dang_ky1" %>
            ...
            <div class="all custom-width-800">
                ...
                <div class="primary-form">
                        ...
                        <div class="form-row-right">
                            <div class="ip">
                                <telerik:RadDateTimePicker RenderMode="Lightweight" ID="rBirthday" ShowPopupOnFocus="true" Width="100%" runat="server"
                                    ...
                                    MinDate="01/01/1900" MaxDate="01/01/2200">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-row-right">
                            <asp:TextBox runat="server" ID="txtUsername" CssClass="form-control has-validate"
                                placeholder="Tên đăng nhập" MaxLength="24"></asp:TextBox>
                            <span class="error-info-show">
                            ...
                            <span style="color: red; font-weight: bold;">
                                ...
                                Quý khách lưu ý :
                                <br />
                                Tên đăng nhập phải lập theo quy cách :<br />
                                " Tên đầy đủ không dấu " + " 2 số cuối năm sinh " - viết liền không dấu.<br />
                                Ví dụ :
                                <br />
                                - Thông tin : Đào Xuân Trường - Sinh năm 1989<br />
                                - Tên tài khoản : daoxuantruong89<br />
                                <br />
                                Mọi tài khoản có tên đăng nhập không đúng theo thông tin, 1688Express sẽ gỡ bỏ mà không cần thông báo.
                            </span>
                            <div class="clearfix"></div>
                    ...
                    <div class="form-row btn-row">
                        <asp:Button ID="btncreateuser" runat="server" Text="Đăng ký" CssClass="pill-btn btn order-btn main-btn hover"

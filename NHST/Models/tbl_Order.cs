...
namespace NHST.Models
{
    ...
    public partial class tbl_Order
    {
        ...
        public Nullable<bool> IsCensorProduct { get; set; }
        public string PriceOfCensorCYN { get; set; }
        public string PriceOfCensorVND { get; set; }
        public Nullable<double> TotalPriceShopCYN { get; set; }
        public Nullable<double> TotalPriceShopVND { get; set; }
        public Nullable<double> TotalShopQuantity { get; set; }
    }
}

            ...
            if (oshop != null)
            {
                if (oshop.Count > 0)
                {
                    ...
                    foreach (var shop in oshop)
                    {
                        ...
                        {
                            html += "           <label style=\"display:none\"><input type=\"checkbox\" name=\"delivery_opt_1\" onclick=\"updatecheck($(this),'" + shop.ID + "','IsFastDelivery')\" checked><span class=\"ip-avata\"></span> <span class=\"ip-label\">Giao tận nhà</span></label>";
                        }
                        else
                        {
                            html += "           <label style=\"display:none\"><input type=\"checkbox\" name=\"delivery_opt_1\" onclick=\"updatecheck($(this),'" + shop.ID + "','IsFastDelivery')\"><span class=\"ip-avata\"></span> <span class=\"ip-label\">Giao tận nhà</span></label>";
                        }
                        if (shop.IsCheckProduct == true)
                        {
                            html += "           <label style=\"display:none\"><input type=\"checkbox\" name=\"delivery_opt_1\" id=\"" + shop.ID + "_checkproductselect\" onclick=\"updatecheck($(this),'" + shop.ID + "','IsCheckProduct')\" checked><span class=\"ip-avata\"></span> <span class=\"ip-label\">Kiểm hàng</span></label>";
                        }
                        else
                        {
                            html += "           <label style=\"display:none\"><input type=\"checkbox\" name=\"delivery_opt_1\" id=\"" + shop.ID + "_checkproductselect\" onclick=\"updatecheck($(this),'" + shop.ID + "','IsCheckProduct')\"><span class=\"ip-avata\"></span> <span class=\"ip-label\">Kiểm hàng</span></label>";
                        }
                        if (shop.IsPacked == true)
                        {
                            html += "           <label style=\"display:none\"><input type=\"checkbox\" name=\"delivery_opt_1\" onclick=\"updatecheck($(this),'" + shop.ID + "','IsPacked')\" checked><span class=\"ip-avata\"></span> <span class=\"ip-label\">Đóng gỗ</span></label>";
                        }
                        else
                        {
                            html += "           <label style=\"display:none\"><input type=\"checkbox\" name=\"delivery_opt_1\" onclick=\"updatecheck($(this),'" + shop.ID + "','IsPacked')\"><span class=\"ip-avata\"></span> <span class=\"ip-label\">Đóng gỗ</span></label>";
                        }
                        html += "       </div>";
                        html += "   </div>";
                            ...
                            if (ors.Count > 0)
                            {
                                foreach (var item in ors)
                                {
                                    ...
                                    html += "               <td class=\"qty\"><input type=\"number\" value=\"" + quantity + "\" class=\"quantitiofpro form-control\" min=\"1\" >"
                                         + "                    <br/><a href=\"javascript:;\" style=\"width:100%;margin-top:5px;\" class=\"pill-btn btn btn-search primary-btn\" onclick=\"updatequantity('" + ID + "',$(this),'" + shop.ID + "')\"><i class=\"fas fa-sync\"></i</a>"
                                         + "                </td>";

<%@ Page Title="" Language="C#" MasterPageFile="~/manager/adminMaster.Master" AutoEventWireup="true" CodeBehind="Order-Transaction-Code.aspx.cs" Inherits="NHST.manager.Order_Transaction_Code" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main id="main-wrap">        
        <h1 class="page-title">Danh sách mã vận đơn</h1>
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="20%" HeaderStyle-HorizontalAlign="Center"
                            ...
                            <ItemTemplate>
                                ...
                                <a class="btn primary-btn" href='/manager/OrderDetail.aspx?id=<%#Eval("MainOrderID") %>'>Xem đơn hàng</a>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>

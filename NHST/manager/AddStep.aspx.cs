...
namespace NHST.manager
{
    public partial class AddStep : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string BackLink = "/manager/StepList.aspx";
            ...
            string kq = StepController.Insert(txtStepName.Text, IMG, Convert.ToInt32(pPartnerIndex.Value), txtStepLink.Text, DateTime.Now, Username);

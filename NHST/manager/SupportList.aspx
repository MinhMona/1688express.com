<%@ Page Title="" Language="C#" MasterPageFile="~/manager/adminMaster.Master" AutoEventWireup="true" CodeBehind="SupportList.aspx.cs" Inherits="NHST.manager.SupportList" %>
                ...
                <MasterTableView CssClass="normal-table" DataKeyNames="ID">
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="20%" HeaderStyle-HorizontalAlign="Center"
                            ...
                            <ItemTemplate>
                                <a class="btn primary-btn" href='/manager/SupportDetail.aspx?id=<%#Eval("ID") %>'>Xem</a>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>

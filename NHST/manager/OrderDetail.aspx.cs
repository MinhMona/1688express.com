                ...
                if (o != null)
                {
                    ...
                    if (obj_user != null)
                    {
                        ...
                        if (!string.IsNullOrEmpty(o.ReceivePlace))
                        {
                            ...
                            if (o.ReceivePlace == "Kho Hà Nội")
                            {
                                hdfReceivePlace.Value = "1";
                            }
                            else
                            {
                                hdfReceivePlace.Value = "2";
                            }
                        }
                        else
                        {
                        ...
                        if (lo.Count > 0)
                        {
                            ...
                            foreach (var item in lo)
                            {
                                ...
                                ltrProducts.Text += "<a href=\"/Admin/ProductEdit.aspx?id=" + item.ID + "\" class=\"left edit-btn\">Sửa</a>";
                                ltrProducts.Text += "<a href=\"javascript:;\" class=\"toggle-detail-row right\"><i class=\"fa fa-caret-down\"></i></a>";
                                ltrProducts.Text += "</td>";
                                ltrProducts.Text += "</tr>";
                                ltrProducts.Text += "<tr class=\"detail-row\">";
                        ...
                        if (cs != null)
                        {
                            if (cs.Count > 0)
                            {
                                foreach (var item in cs)
                                {
                                    ...
                                    ltrInComment.Text += "<div class=\"img\"></div>";
                            ...
                            {
                                ltrInComment.Text += "Hiện chưa có đánh giá nào.";
                            }
                        }
                        else
                        {
                        ...
                        if (cs1 != null)
                        {
                            if (cs1.Count > 0)
                            {
                                foreach (var item in cs1)
                                {
                                    ...
                                    ltrOutComment.Text += "<div class=\"img\"></div>";
                            ...
                            {
                                ltrOutComment.Text += "Hiện chưa có đánh giá nào.";
                            }
                        }
                        else
                        {
                        ...
                        if (smallpackages.Count > 0)
                        {
                            foreach (var s in smallpackages)
                            {
                                ...
                                spsList.Append("        <input class=\"transactionWeight form-control\" value=\"" + s.Weight + "\" type=\"text\" placeholder=\"Cân nặng\" onkeyup=\"gettotalweight()\" />");
                                spsList.Append("    </div>");
                                spsList.Append("    <div class=\"item-element\">");
                        ...
                        if (!string.IsNullOrEmpty(tcl))
                        {
                            ...
                            for (int i = 0; i < list.Length - 1; i++)
                            {
                                ...
                                if (ID > 0)
                                {
                                    ...
                                    {
                                        SmallPackageController.InsertWithMainOrderID(id, 0, code, "", 0, Convert.ToDouble(weight), 0, smallpackage_status, currentDate, username);
                                    }
                                }
                                else
                                {

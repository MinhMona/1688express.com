...
namespace NHST
{
    public partial class Default1 : System.Web.UI.Page
    {
        ...
        public void sendMessage()
        {
            ...
            try
            {
                PJUtils.SendMailGmail("order1688express@gmail.com", "tkvrdkmkrzgbfjss", "phuong.nguyenthanh90@gmail.com", "Reset Mật khẩu trên Vận chuyển đa quốc gia", "Mật khẩu mới của bạn trên hệ thống Vận chuyển đa quốc gia: <strong>hehe</strong>", "");
            }
            catch { }
        }
        [WebMethod]

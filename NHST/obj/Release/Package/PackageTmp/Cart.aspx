<%@ Page Title="" Language="C#" MasterPageFile="~/1688MasterLogined.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="NHST.Cart1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main id="home">
        <section id="firm-services" class="services">
            <div class="all">
                <h4 class="sec__title center-txt">Giỏ hàng</h4>
                <div class="primary-form">
                    <div class="order-tool clearfix">
                        <div class="primary-form custom-width">
                            <div class="order-tool clearfix">
                                <div class="tool-detail">
                                    <div class="sec step-sec default-3-style padding-topbot-10">
                                        <div class="steps">
                                    ...
                                    <div class="sec warning-sec default-3-style  padding-topbot-10">
                                        <div class="sec-tt">
                        ...
                        tối thiểu và sẽ từ chối bán nếu không đáp ứng. Trong trường hợp đó 1688 Express sẽ hủy những đơn hàng này và không báo trước.
                                    ...
                                    <div class="sec gray-area" style="display:block">
                                        <div class="sec-tt">
                                        ...
                                        <div class="search-internal-box">
                                            <select class="form-control _select_category pill-control savedb" data-loaded="1" style="display: none">
                                            ...
                                            <a class="pill-btn btn btn main-btn hover btn-1" onclick="add_to_cart();" style="font-size: 13px;">Thêm vào giỏ hàng</a>
                                        </div>
                                    </div>
                                    <div class="sec table-price-sec" style="margin-top:50px;display:inline-block">
                                        <div class="tbp-top">
    ...
    <script type="text/javascript">
        ...
        function updatequantity(ID, obj, shopid) {
            var quantity = obj.parent().find(".quantitiofpro").val();
            if (quantity == 0) {
                deleteordertemp(ID, shopid);
            }
            else {
    ...
    <style>
        .form-control.pill-control, .btn.pill-btn {
            border-radius: unset;
        }
    </style>
</asp:Content>

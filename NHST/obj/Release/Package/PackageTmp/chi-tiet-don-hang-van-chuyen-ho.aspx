<%@ Page Title="" Language="C#" MasterPageFile="~/1688MasterLogined.Master" AutoEventWireup="true" CodeBehind="chi-tiet-don-hang-van-chuyen-ho.aspx.cs" Inherits="NHST.chi_tiet_don_hang_van_chuyen_ho" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main id="home">
        <section id="firm-services" class="services">
            <div class="all">
                <h4 class="sec__title center-txt">Chi tiết đơn hàng vận chuyển hộ</h4>
                <div class="cont">
                    <div class="inner">

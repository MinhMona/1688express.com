<%@ Page Title="" Language="C#" MasterPageFile="~/manager/adminMaster.Master" AutoEventWireup="true" CodeBehind="AddStep.aspx.cs" Inherits="NHST.manager.AddStep" %>
                    ...
                    <div class="feat-row grid-row">
                        <div class="grid-col-50 grid-row-center">
                            <article class="pane-primary">
                                <div class="heading">
                                    <h3 class="lb">Thêm bước</h3>
                                </div>
                                <div class="cont">
                                    <div class="inner">
                                        <div class="form-row marbot1">
                                            Tên bước <span class="require">(*)</span>
                                            <asp:RequiredFieldValidator runat="server" ID="rq" ControlToValidate="txtStepName"
                                                ValidationGroup="n" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="form-row marbot2">
                                            <asp:TextBox runat="server" ID="txtStepName" CssClass="form-control"></asp:TextBox>
                                        </div>
                                        ...
                                        <div class="form-row marbot2">
                                            <asp:TextBox runat="server" ID="txtStepLink" CssClass="form-control"></asp:TextBox>
                                        </div>
                                        ...
                                        <div class="form-row no-margin center-txt">
                                            ...
                                            <a href="/manager/StepList.aspx" class="btn primary-btn">Trở về</a>
                                        </div>
                                    </div>
                                </div>
                            </article>

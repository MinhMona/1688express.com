<%@ Page Title="" Language="C#" MasterPageFile="~/manager/adminMaster.Master" AutoEventWireup="true" CodeBehind="HistorySendWalletAccountant.aspx.cs" Inherits="NHST.manager.HistorySendWalletAccountant" %>
            ...
            <telerik:RadGrid runat="server" ID="gr" OnNeedDataSource="r_NeedDataSource" AutoGenerateColumns="False"
                ...
                <MasterTableView CssClass="normal-table" DataKeyNames="ID">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="TradeContent" HeaderText="Nội dung" HeaderStyle-Width="5%">
                        </telerik:GridBoundColumn>

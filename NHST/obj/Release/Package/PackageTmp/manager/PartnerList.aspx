<%@ Page Title="" Language="C#" MasterPageFile="~/manager/adminMaster.Master" AutoEventWireup="true" CodeBehind="PartnerList.aspx.cs" Inherits="NHST.manager.PartnerList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main id="main-wrap">
        <a type="button" class="btn primary-btn" href="/manager/AddPartner.aspx">Thêm đối tác</a>
        <h1 class="page-title">Danh sách đối tác</h1>
                ...
                <MasterTableView CssClass="normal-table" DataKeyNames="ID">
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="10%" HeaderStyle-HorizontalAlign="Center"
                            ...
                            <ItemTemplate>
                                <a class="btn primary-btn" href='/manager/EditPartner.aspx?i=<%#Eval("ID") %>'>Sửa</a>
                                <a class="btn primary-btn bg-red" href="javascript:;" onclick="DeletePartner('<%#Eval("ID") %>')">Xóa</a>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>

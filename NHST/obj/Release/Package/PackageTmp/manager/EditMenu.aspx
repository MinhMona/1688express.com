<%@ Page Title="" Language="C#" MasterPageFile="~/manager/adminMaster.Master" AutoEventWireup="true" CodeBehind="EditMenu.aspx.cs" Inherits="NHST.manager.EditMenu" %>
                                ...
                                <div class="cont">
                                    <div class="inner">
                                        ...
                                        <div class="form-row no-margin center-txt">
                                            ...
                                            <a href="/manager/MenuList.aspx" class="btn primary-btn">Trở về</a>
                                        </div>
                                    </div>
                                </div>
                            </article>

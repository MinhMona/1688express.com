                    ...
                    <div id="advance-search" data-css='{"display": "none"}'>
                        ...
                        <div class="grid-col-100">
                            ...
                            <%-- <select class="form-control" id="tag" multiple>
                                <option value="bg-red" data-value="-1">Tất cả</option>
                                <option value="bg-red" data-value="0">Chờ đặt cọc</option>
                                <option value="bg-black" data-value="1">Hủy đơn hàng</option>
                                <option value="bg-bronze" data-value="2">Khách đã đặt cọc</option>
                                <option value="bg-green" data-value="5">Đã mua hàng</option>
                                <option value="bg-green" data-value="6">Đã nhận hàng tại TQ</option>
                                <option value="bg-green" data-value="7">Đã nhận hàng tại VN</option>
                                <option value="bg-blue" data-value="9">Khách đã thanh toán</option>
                                <option value="bg-blue" data-value="10">Đã hoàn thành</option>
                            </select>--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/manager/adminMaster.Master" AutoEventWireup="true" CodeBehind="StepList.aspx.cs" Inherits="NHST.manager.StepList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main id="main-wrap">
        <a type="button" class="btn primary-btn" href="/Admin/AddStep.aspx">Thêm các bước</a>
        <h1 class="page-title">Danh sách các bước</h1>

<%@ Page Title="" Language="C#" MasterPageFile="~/1688MasterLogined.Master" AutoEventWireup="true" CodeBehind="danh-sach-don-van-chuyen-ho.aspx.cs" Inherits="NHST.danh_sach_don_van_chuyen_ho" %>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <asp:DropDownList ID="ddlStatus" runat="server" CssClass="form-control">
                                                    ...
                                                    <asp:ListItem Value="4" Text="Đang chuyển về kho đích"></asp:ListItem>

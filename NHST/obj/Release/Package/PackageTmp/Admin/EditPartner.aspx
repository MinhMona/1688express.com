<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EditPartner.aspx.cs" Inherits="NHST.Admin.EditPartner" %>
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <a href="/admin/PartnerList.aspx" class="btn btn-success">Trở về</a>
                                </div>
                            </div>
                        </div>
                    </div>

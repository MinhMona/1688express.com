<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Page-Type-List.aspx.cs" Inherits="NHST.Admin.Page_Type_List" %>
        ...
        <div class="col-md-12">
            <div class="panel panel-white">
                ...
                <div class="panel-body">
                    <a type="button" class="btn btn-success m-b-sm" href="/Admin/AddPageType.aspx">Thêm danh mục</a>
                        ...
                        <telerik:RadGrid runat="server" ID="gr" OnNeedDataSource="r_NeedDataSource" AutoGenerateColumns="False"
                            ...
                            <MasterTableView CssClass="table table-bordered table-hover" DataKeyNames="ID">
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="PageTypeName" HeaderText="Tên danh mục" HeaderStyle-Width="5%">
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Thuộc loại" HeaderStyle-Width="10%"
                                        ...
                                        <ItemTemplate>
                                            <%# PageTypeController.GetByID(Convert.ToInt32(Eval("PageTypeID"))).PageTypeName %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>--%>
                                    ...
                                    <telerik:GridTemplateColumn HeaderStyle-Width="10%" HeaderStyle-HorizontalAlign="Center"
                                        ...
                                        <ItemTemplate>
                                            <a class="btn btn-info btn-sm" href='/Admin/Edit-Paget-Type.aspx?i=<%#Eval("ID") %>'>Sửa</a>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                </Columns>

<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="BigPackageDetail.aspx.cs" Inherits="NHST.Admin.BigPackageDetail" %>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group no-margin">
                                    <a href="javascript:;" class="btn btn-success btn-block small-btn" onclick="createNewPackage()" style="margin-bottom: 10px;" onkeydown="return (event.keyCode!=13)">Cập nhật</a>
                                    <a href="javascript:;" class="btn btn-success btn-block small-btn" onclick="sendMail()" style="margin-bottom: 10px;" onkeydown="return (event.keyCode!=13)">Gửi mail</a>
                                    <a href="/admin/BigPackageList.aspx" class="btn btn-success btn-block small-btn" onkeydown="return (event.keyCode!=13)">Hủy</a>
                                    <asp:Button ID="btncreateuser" runat="server" Text="Tạo mới" CssClass="btn btn-success btn-block large-btn" onkeydown="return (event.keyCode!=13)"
                                        OnClick="btncreateuser_Click" Style="display: none;" ValidationGroup="create" UseSubmitBehavior="false" />
                                    <asp:Button ID="btnSendmail" runat="server" Text="Send Mail" CssClass="btn btn-success btn-block large-btn"
    ...
    <telerik:RadScriptBlock ID="sc" runat="server">
        ...
        <script type="text/javascript">
            ...
            function addMorePackage() {
                ...
                //        html += "<div class=\"row smallpackage\" style=\"padding: 20px 0;\">";
                //        html += "<div class=\"col-md-2\" style=\"padding-top: 5px;padding-bottom:5px;\">Mã vận đơn:</div>";
                //        html += "<div class=\"col-md-2\" style=\"padding-top: 5px;padding-bottom:5px;\"><input disabled type=\"text\" class=\"packageCode form-control\" value=\"" + data + "\"/></div>";
                //        html += "<div class=\"col-md-2\" style=\"padding-top: 5px;padding-bottom:5px;\">User Phone:</div>";
                //        html += "<div class=\"col-md-2\" style=\"padding-top: 5px;padding-bottom:5px;\"><input type=\"text\" class=\"packageUserPhone form-control\" /></div>";
                //        html += "<div class=\"col-md-2\" style=\"padding-top: 5px;padding-bottom:5px;\">Trọng lượng:</div>";
                //        html += "<div class=\"col-md-2\" style=\"padding-top: 5px;padding-bottom:5px;\"><input class=\"packageWeight form-control\" /></div>";

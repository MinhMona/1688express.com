<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="add-withdraw.aspx.cs" Inherits="NHST.Admin.add_withdraw" %>
            ...
            <div class="col-md-12">
                <div class="panel panel-white">
                    <div class="panel-heading">
                        <h3 class="panel-title semi-text text-uppercase">Tạo lệnh rút tiền</h3>
                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group marbot2">
                                    <telerik:RadNumericTextBox runat="server" CssClass="form-control" Skin="MetroTouch"
                                        ...
                                        NumberFormat-GroupSizes="3" Width="70%" placeholder="Số tiền muốn rút">

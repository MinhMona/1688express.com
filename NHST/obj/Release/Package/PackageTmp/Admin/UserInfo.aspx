                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group marbot2">
                                    <telerik:RadDateTimePicker RenderMode="Lightweight" ID="rBirthday" ShowPopupOnFocus="true" Width="100%" runat="server"
                                        DateInput-CssClass="radPreventDecorate" placeholder="Ngày sinh" CssClass="date" DateInput-EmptyMessage="Ngày sinh" MinDate="01/01/1900 00:00:00">
                                ...
                                <asp:Panel ID="pnAdmin" runat="server" Visible="false">
                                    <div class="form-group col-md-12">
                                        <label for="exampleInputName">Đại lý</label>
                                        <br />
                                        <asp:CheckBox ID="chkIsAgent" runat="server" />
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="exampleInputName">TK nội bộ</label>
                                        <br />
                                        <asp:CheckBox ID="chkIsLocal" runat="server" />
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="exampleInputName">TK Vip</label>
                                        <br />

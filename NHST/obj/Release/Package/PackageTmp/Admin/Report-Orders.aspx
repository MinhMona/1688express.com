                        ...
                        <div class="row m-b-lg">
                            ...
                            <asp:Panel ID="pninfo" runat="server" Visible="false">
                                <div class="col-md-12" style="margin-top: 20px;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12" style="margin-top: 20px;">
                                            <span class="label-title">Tổng đơn hàng đã nhận hàng tại kho đích</span>
                                            <span class="label-infor">
                                ...
                                <div class="col-md-12" style="margin-top: 50px;">
                                    <div class="row"><asp:Button ID="btnExport" CssClass="btn btn-success" runat="server" Text="Xuất file Excel" OnClick="btnExport_Click" /></div>
                                    <div class="row">

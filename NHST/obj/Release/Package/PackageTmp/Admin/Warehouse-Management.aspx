<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Warehouse-Management.aspx.cs" Inherits="NHST.Admin.Warehouse_Management" %>
        ...
        <div class="col-md-12">
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h3 class="panel-title semi-text text-uppercase">Danh sách bao hàng</h3>
                </div>
                            ...
                            <MasterTableView CssClass="table table-bordered table-hover" DataKeyNames="ID">
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Trạng thái" HeaderStyle-Width="10%"
                                        ...
                                        <ItemTemplate>
                                            <%# PJUtils.IntToStringStatusPackage(Convert.ToInt32(Eval("Status"))) %>
                                        </ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderStyle-Width="20%" HeaderStyle-HorizontalAlign="Center"
                                        ...
                                        <ItemTemplate>
                                            <a class="btn btn-info btn-sm" href='/Admin/Package-Detail.aspx?ID=<%#Eval("ID") %>'>Sửa</a>                                            
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                </Columns>
                        ...
                        <telerik:RadGrid runat="server" ID="gr" OnNeedDataSource="r_NeedDataSource" AutoGenerateColumns="False"
                            ...
                            <MasterTableView CssClass="table table-bordered table-hover" DataKeyNames="ID">
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="OrderCodeList" HeaderText="Danh sách kiện" HeaderStyle-Width="5%"
                                        FilterControlWidth="50px" AutoPostBackOnFilter="false"
                                        CurrentFilterFunction="Contains" FilterDelay="2000" ShowFilterIcon="false">
                                    </telerik:GridBoundColumn>

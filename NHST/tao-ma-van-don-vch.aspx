<%@ Page Title="" Language="C#" MasterPageFile="~/1688MasterLogined.Master" AutoEventWireup="true" CodeBehind="tao-ma-van-don-vch.aspx.cs" Inherits="NHST.tao_ma_van_don_vch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main id="home">
        <section id="firm-services" class="services">
            <div class="all">
                <h4 class="sec__title center-txt">Tạo đơn hàng vận chuyển hộ</h4>
                <div class="cont">
                    <div class="inner">
                        ...
                        <div class="form-row marbot1">
                            ...
                            <a href="javascript:;" onclick="deleteAllProduct()" id="deleteAllProduct" class="btn btn-success btn-block pill-btn primary-btn main-btn hover custom-padding-display" style="display: none; float: right">
                                <i class="fa fa-close"></i>Xóa hết kiện
                            </a>
                        </div>
                        <div class="form-row marbot2">
                                ...
                                <table class="customer-table mar-top1 full-width normal-table">
                                    ...
                                    <tbody class="product-list">
                                        <tr class="product-item">
                                            ...
                                            <td>
                                                <input class="product-quantity form-control margin-custom-5" placeholder="Ghi chú"/></td>
                                            <td><a href="javascript:;" onclick="deleteProduct($(this))" class="btn btn-bg-close"><i class="fa fa-window-close"></i></a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="form-row-marbot2">
                            <a href="javascript:;" onclick="addProduct()" class="btn btn-success btn-block pill-btn primary-btn main-btn hover custom-padding-display" style="float: right; margin-right: 5px; width: auto;"><i class="fa fa-plus"></i> Thêm kiện</a>
                        </div>
                        <%-- <div class="form-row marbot1">
                            Ghi chú
                        </div>
    ...
    <script type="text/javascript">
        function addProduct() {
            ...
            html += "   <td><input class=\"product-quantity form-control margin-custom-5\" placeholder=\"Ghi chú\"  value=\"\"/></td>";
            html += "   <td><a href=\"javascript:;\" onclick=\"deleteProduct($(this))\" class=\"btn btn-bg-close\"><i class=\"fa fa-window-close\"></i></a></td>";
            html += "</tr>";
